...
import { checkProfilePassword } from "@/services/AuthAPI";
...
export default function DeleteProjectModal() {
  ...
  const checkPasswordFromUser = useMutation({
    mutationFn: checkProfilePassword,
    onError: (error) => {
  ...
  const handleForm = async (formData: CheckPassword) => {
    await checkPasswordFromUser.mutateAsync(formData);
